...
/*
 * This program calculates how may documents there are,
 * min, avg and max number of sentences in the document
 * max, avg and max document length by the number of tokens
 * Average sentence length by number of tokens for the wole file and by individual documents
 */
public class Stats {
    /*
    * Utility file reading function borrowed form the sample and modified to split by line
    */   
